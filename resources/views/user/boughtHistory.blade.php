...
<head>
    <meta charset="utf-8">
    <title>eLEARNING - Lịch sử giao dịch</title>
            ...
            <div class="navbar-nav ms-auto p-4 p-lg-0">
                ...
                <div class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu fade-down m-0">
                        ...
                        <a href="boughtHistory.html" class="dropdown-item active">lịch sử mua</a>
        ...
        <div class="container py-5">
            <div class="row justify-content-center">
                <div class="col-lg-10 text-center">
                    <h1 class="display-3 text-white animated slideInDown">Lịch sử giao dịch</h1>
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb justify-content-center">
                            <li class="breadcrumb-item"><a class="text-white" href="#">Trang chủ</a></li>
                            <li class="breadcrumb-item"><a class="text-white" href="#">Tài khoản cá nhân</a></li>
                            <li class="breadcrumb-item text-white active" aria-current="page">Lịch sử mua</li>
                        </ol>
                    </nav>
                </div>
            </div>
...
<div class="container-xxl py-5">
    <div class="container">
        <h4 class="mb-4">Tài liệu đã mua</h4>
        <div class="table-responsive">
            <table class="table table-striped">
                ...
                <tbody>
                    <tr>
                        <td>1</td>
                        <td>Giáo trình Toán cao cấp</td>
                        <td>12/05/2025</td>
                        <td>20.000đ</td>
                        <td><span class="badge bg-success">Thành công</span></td>
                        <td><a href="#" class="btn btn-sm btn-primary">Tải xuống</a></td>
                    </tr>
                    <tr>
                        <td>2</td>
                        <td>Lịch sử Việt Nam hiện đại</td>
                        <td>10/05/2025</td>
                        <td>15.000đ</td>
                        <td><span class="badge bg-success">Thành công</span></td>
                        <td><a href="#" class="btn btn-sm btn-primary">Tải xuống</a></td>
