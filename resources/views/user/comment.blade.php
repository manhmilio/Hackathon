...
<head>
    <meta charset="utf-8">
    <title>eLEARNING - Bình luận</title>
...
<body>
    ...
    <nav class="navbar navbar-expand-lg bg-white navbar-light shadow sticky-top p-0">
        ...
        <div class="collapse navbar-collapse" id="navbarCollapse">
            <div class="navbar-nav ms-auto p-4 p-lg-0">
                ...
                <a href="comment.html" class="nav-item nav-link active">Bình luận</a>
        ...
        <div class="container py-5">
            <div class="row justify-content-center">
                <div class="col-lg-10 text-center">
                    <h1 class="display-3 text-white animated slideInDown">Góp ý</h1>
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb justify-content-center">
                            <li class="breadcrumb-item"><a class="text-white" href="#">Trang chủ</a></li>
                            <li class="breadcrumb-item text-white active" aria-current="page">Bình luận</li>
                        </ol>
                    </nav>
                </div>
            </div>
    ...
    <div class="bg-white shadow rounded p-4">
        <h4 class="mb-4">Góp ý và bình luận</h4>
        <form action="#" method="post">
            <div class="mb-3">
                <label class="form-label">Nội dung</label>
                <textarea class="form-control" rows="4" placeholder="Viết bình luận hoặc góp ý..." required></textarea>
            </div>
