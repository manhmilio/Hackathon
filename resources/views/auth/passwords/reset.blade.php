                    ...
                    <div class="w-100">
                        <div class="d-flex flex-column h-100">
                            ...
                            <div class="my-auto">
                                ...
                                <!-- Thêm thông báo lỗi chung từ controller -->
                                @if (session('error'))
                                ...
                                <div class="mt-4">
                                    <form class="form-horizontal" method="POST" action="{{ route('password.update') }}">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input id="password-confirm" type="password" name="password_confirmation" class="form-control @error('password_confirmation') is-invalid @enderror" placeholder="Enter confirm password">
                                    ...
                                    <div class="mt-5 text-center">
                                        <p>Remember It ? <a href="{{ route('login.login') }}" class="font-weight-medium text-primary"> Sign In here</a> </p>
                                    </div>
                                </div>
                            </div>
