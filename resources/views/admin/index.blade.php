            ...
            <div class="card-body pt-0">
                <div class="row">
                    <div class="col-sm-4">
                        ...
                        <h5 class="font-size-15 text-truncate">{{ isset(Auth::user()->username) ? Auth::user()->username : 'Guest'}}</h5>
                    ...
                    <div class="col-sm-8">
                        <div class="pt-4">
                            ...
                            <div class="mt-4">
                                <a href="{{ route('contacts-profile') }}" class="btn btn-primary waves-effect waves-light btn-sm">View Profile <i class="mdi mdi-arrow-right ms-1"></i></a>
                            </div>
                        </div>
                    </div>
                </div>
