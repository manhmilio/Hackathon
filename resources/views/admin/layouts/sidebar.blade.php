            ...
            <ul class="metismenu list-unstyled" id="side-menu">
                ...
                <li>
                    ...
                    <ul class="sub-menu" aria-expanded="false">
                        ...
                        <li><a href="{{ route('contacts-profile') }}" key="t-profile">@lang('translation.Profile')</a></li>                    </ul>
                </li>
                ...
                <li>
                    ...
                    <ul class="sub-menu" aria-expanded="false">
                        ...
                        <li><a href="event-apply" key="t-apply-job">@lang('translation.Apply_Job')</a></li>
                        <li><a href="event-details" key="t-job-details">@lang('translation.Job_Details')</a></li>
                        <li><a href="event-categories" key="t-Jobs-categories">@lang('translation.Jobs_Categories')</a></li>
                        <li>
